        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="<?= base_url("user/edit/$input->id_user") ?>" method="POST">
                        <?= form_hidden('id_user', $input->id_user) ?>
                        <div class="form-body">
                                    ...
                                    <div class="col-lg-10">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="input-group">
                                                    <div class="input-group-prepend">
                                                        <label class="input-group-text" for="role-options"><i class="fas fa-id-badge"></i></label>
                                                    </div>
